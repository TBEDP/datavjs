...
;(function (name, definition) {
     ...
     * ```
     * @param {obj} dimenType  dimension type obj
     */
     ...
     * @return {obj}  key: dimension name(column name); value: dimenType("ordinal" or "quantitativ")
     */
     ...
     *  });
     * ```
     * @param {obj} dimenExtent key: dimension name(column name); value: extent array;
     */
     ...
     * @return {obj}  key: dimension name(column name); value: extent array;
     */
     ...
     *  });
     * ```
     * @param {obj} dimenDomain: key: dimension name(column name); value: domain array (quantitative domain is digit array whose length is 2, ordinal domain is string array whose length could be larger than 2;
     */
    ...
    Parallel.prototype.on = function (eventName, callback) {
        if (_.indexOf(["brushstart", "brushend", "brush"], eventName)) {
     ...
     * @param {obj} d: json, key: dimension name(column name); value: value of related dimension;
