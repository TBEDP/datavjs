...
;(function (name, definition) {
     ...
     *   - `ms` 数字，动画持续时间，默认300
     *   - `easing` 字符串，动画类型，默认“bounce”。详见rapheal相关文档，可以使用“linear”，“easeIn”，“easeOut”，“easeInOut”，“backIn”，“backOut”，“elastic”，“bounce”
     *
     * Examples:
    ...
    Pie.prototype.render = function () {
        ...
        var mouseClick = function () {
            ...
            var angle = 0.5 * ((groups[index].startAngle + groups[index].endAngle) - Math.PI);
            var center = {
    ...
    Pie.prototype.legend = function () {
        ...
        rectBn.forEach(function (d, i) {
            ...
            d.click(function () {
                ...
                var angle = 0.5 * ((groups[i].startAngle + groups[i].endAngle) - Math.PI);
                var center = {
                    x: ((conf.width - that.xOffset) / 2 + that.xOffset),
                    y: conf.height / 2
                };
