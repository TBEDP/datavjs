...
;(function (name, definition) {
    ...
    var ScatterplotMatrix = DataV.extend(DataV.Chart, {
        initialize: function (node, options) {
            ...
            /*
            //图例区域的左上顶点坐标x，y，宽，高
            this.defaults.legendArea = [20, (this.defaults.height - 20 - 220), this.defaults.legendWidth, 220];
            //简介区域的左上角顶点坐标x，y，宽，高
            this.defaults.introArea = [20, 20, this.defaults.legendWidth, 200];
            //散点矩阵区域的左上顶点坐标x，y，宽，高
            this.defaults.diagramArea = [this.defaults.legendWidth + 20 * 2, 20, (this.defaults.width - this.defaults.legendWidth - 20 * 2), (this.defaults.height - 40)];
            */
