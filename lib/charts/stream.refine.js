...
;(function (name, definition) {
  ...
  //floatTag
  var FloatTag = DataV.extend(DataV.Widget, {
  ...
  //cover
  var Cover = DataV.extend(DataV.Widget, {
  ...
  Stream.prototype.createComponents = function () {
    ...
    this.percentage = this.own(new Percentage(this.percentageContainer));
    ...
    // legend
    var legend = conf.legendPosition === "left" ? new Legend.Legend(this.legendContainer)
      : new Legend.TopLegend(this.legendContainer);
    this.legend = this.own(legend);
