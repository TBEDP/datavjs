...
var fdnet = new Bundle(document.createElement("div"), {});
...
test("prototype.setSource", function () {
    var source = [
        ["name","size","imports"],
        ["flare.vis.data.DataList",2867,"flare.analytics.cluster.CommunityStructure"],
        ["flare.analytics.cluster.CommunityStructure",1983,"flare.vis.data.DataList"]
    ];
